    ...
    <div class="card">
        <div class="card-header" style="padding:20px 24px 0;">
            <div style="display:flex;align-items:center;gap:12px;padding-bottom:16px;border-bottom:0.5px solid var(--border);">
                ...
                <div>
                    <div style="font-size:15px;font-weight:600;">Edit Vehicle</div>
                    <div style="font-size:12px;color:var(--muted);margin-top:2px;">
                        Updating — {{ $vehicle->make }} {{ $vehicle->model }} ({{ $vehicle->plate_number }})
                    </div>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('vehicles.update', $vehicle->id) }}" method="POST">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                    ...
                    <div style="grid-column:span 2;">
                        ...
                        <input type="text" name="plate_number" value="{{ old('plate_number', $vehicle->plate_number) }}" required maxlength="20"
                    ...
                    <div>
                        ...
                        <input type="text" name="make" value="{{ old('make', $vehicle->make) }}" required maxlength="50"
                    ...
                    <div>
                        ...
                        <input type="text" name="model" value="{{ old('model', $vehicle->model) }}" required maxlength="50"
                ...
                <div style="display:flex;gap:10px;margin-top:24px;padding-top:20px;border-top:0.5px solid var(--border);">
                    <button type="submit" class="btn btn-primary" style="flex:1;justify-content:center;">
                        <i class="ti ti-device-floppy" style="font-size:14px"></i> Update Vehicle
                    </button>
